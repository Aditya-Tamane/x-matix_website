...
// };
  ...
  const showStepLayout = data.showStepLayout;
  const showCardLayout = data.showCardLayout;
  return (
    <>
      <SectionCard
    ...
    {showStepLayout && <BigCard {...data?.stepsLayoutData} />}
    {showCardLayout && <BigCard {...data?.cardLayoutData} />}
